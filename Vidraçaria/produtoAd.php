...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $result = mysqli_query($conexao, "INSERT INTO produtos(codigo,descricao,unidade,valor) VALUES ('$codigo','$descricao','$unidade','$valor')");
...
@media screen and (max-width: 576px) {
	...
	<title>Vidraçaria Lucas ◈ Produtos</title>
</head>
<body>
	...
	<section id="content">
		...
		<main>
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="produtos.php">Voltar</a>
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="table-data">
				<div class="order">
                <form action="produtoAd.php" method="POST">
					<div class="head">
