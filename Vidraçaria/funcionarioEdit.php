	...
	<section id="content">
		...
		<main>
			...
			<div class="table-data">
				<div class="order">
                <form action="funcionarioSave.php" method="POST">
					<div class="head">
						<h3>Editor de Funcionários</h3>
					</div>
					<br><br>
					<table>
						<thead>
                ...
                <br><br>
                <div class="inputBox">
                    <input type="text" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" name="cpf" id="cpf" class="inputUser" value="<?php echo $cpf ?>" required>
