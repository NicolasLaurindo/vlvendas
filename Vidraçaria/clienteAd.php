...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $result = mysqli_query($conexao, "INSERT INTO clientes(nome,cpf,telefone,cidade,bairro,endereco) VALUES ('$nome','$cpf','$telefone','$cidade','$bairro','$endereco')");
...
@media screen and (max-width: 576px) {
	...
	<title>Vidraçaria Lucas ◈ Clientes</title>
</head>
<body>
	...
	<section id="content">
		...
		<main>
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="clientes.php">Voltar</a>
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="table-data">
				<div class="order">
                <form action="clienteAd.php" method="POST">
					<div class="head">
