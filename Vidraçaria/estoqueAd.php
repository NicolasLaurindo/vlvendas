...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $result = mysqli_query($conexao, "INSERT INTO estoque(codigo,descricao,unidade,valor,quantidade) VALUES ('$codigo','$descricao','$unidade','$valor','$quantidade')");
...
@media screen and (max-width: 576px) {
	...
	<title>Vidraçaria Lucas ◈ Estoque</title>
</head>
<body>
	...
	<section id="content">
		...
		<main>
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="estoque.php">Voltar</a>
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="table-data">
				<div class="order">
                <form action="estoqueAd.php" method="POST">
					<div class="head">
						<h3>Adicionar no Estoque</h3>
					</div>
					<br><br>
					<table>
						<thead>
