...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $result = mysqli_query($conexao, "INSERT INTO tabela(codigo,descricao,unidade,valor,quantidade,desconto) VALUES ('$codigo','$descricao','$unidade','$valor','$quantidade','$desconto')");
	...
	<section id="content">
		...
		<main>
			...
			<div class="table-data">
				<div class="order">
                <form action="tabelaAd.php" method="POST">
					<div class="head">
						<h3>Adicionar na Tabela</h3>
					</div>
					<br><br>
					<table>
						<thead>
                ...
                <br><br>
                <div class="inputBox">
                    <input type="text" name="desconto" id="desconto" class="inputUser" required>
