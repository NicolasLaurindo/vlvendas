	...
	<section id="content">
		...
		<main>
			...
			<div class="table-data">
				<div class="order">
                <form action="fornecedorSave.php" method="POST">
					<div class="head">
						<h3>Editor de Fornecedores</h3>
					</div>
					<br><br>
					<table>
						<thead>
                ...
                <br><br>
                <div class="inputBox">
                    <input type="text" pattern="\d{2}\.\d{3}\.\d{3}/\d{4}-\d{2}" name="cnpj" id="cnpj" class="inputUser" value="<?php echo $cnpj ?>" required>
                ...
                <br><br>
                <div class="inputBox">
                    <input type="tel" name="contato" id="contato" class="inputUser" value="<?php echo $contato ?>" required>
