...
if(!empty($_GET['search']))
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM clientes WHERE id LIKE '%$data%' or nome LIKE '%$data%' or cpf LIKE '%$data%' ORDER BY id DESC";
    }
    else
    {
			...
			<div class="table-data">
				<div class="order">
                    ...
                    while($user_data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>
							<a class='btn btn-primary' href='clienteEdit.php?id=".$user_data['id']."'>
								<i class='fa-solid fa-pen' style='background-color: #3498db; color: white; border-radius: 50%; padding: 10px;'></i>
							</a>
								<span style='margin-right: 10px;'></span>
							<a class='btn btn-danger' href='clienteDel.php?id=".$user_data['id']."'>
