...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $result = mysqli_query($conexao, "INSERT INTO funcionarios(nome,cpf,telefone,cidade,bairro,endereco,funcao) VALUES ('$nome','$cpf','$telefone','$cidade','$bairro','$endereco','$funcao')");
...
@media screen and (max-width: 576px) {
	...
	<title>Vidraçaria Lucas ◈ Funcionários</title>
</head>
<body>
	...
	<section id="content">
		...
		<main>
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="funcionarios.php">Voltar</a>
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="table-data">
				<div class="order">
                <form action="funcionarioAd.php" method="POST">
					<div class="head">
                ...
                <br><br>
                <div class="inputBox">
                    <input type="text" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" name="cpf" id="cpf" class="inputUser" required>
