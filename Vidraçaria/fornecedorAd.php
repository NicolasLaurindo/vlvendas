...
<?php
    ...
    {   
        ...
        $result = mysqli_query($conexao, "INSERT INTO fornecedores(fornecedor,empresa,cnpj,cidade,bairro,endereco,telefone,contato) VALUES ('$fornecedor','$empresa','$cnpj','$cidade','$bairro','$endereco','$telefone','$contato')");

		if($result) {
			// Redirecionamento para clientes.php após a inserção bem-sucedida
	...
	<section id="content">
		...
		<main>
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="fornecedores.php">Voltar</a>
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="table-data">
				<div class="order">
                <form action="fornecedorAd.php" method="POST">
					<div class="head">
                    ...
                    <label for="fornecedor" class="labelInput">Fornecedor de</label>
                </div>
                <br><br>
                <div class="inputBox">
                ...
                <br><br>
                <div class="inputBox">
                    <input type="text" pattern="\d{2}\.\d{3}\.\d{3}/\d{4}-\d{2}" name="cnpj" id="cnpj" class="inputUser" required>
                ...
                <br><br>
                <div class="inputBox">
                    <input type="tel" name="contato" id="contato" class="inputUser" required>
                    <label for="contato" class="labelInput">Contatos Vendedor</label>
                </div>
                <br><br>
                <button type="submit" class="continue-application button-clientes" name="submit" id="submit">
                    <div>
